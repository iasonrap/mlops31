...
def test_animals_dataset_initialization():
    image_paths = ["src/animals/data/raw/raw-img/cane/OIF-e2bexWrojgtQnAPPcUfOWQ.jpeg", "src/animals/data/raw/raw-img/cane/OIP-__Yu1XH3iAC10OzGQFpC-AHaE8.jpeg"]
    targets = [0, 1]
...
def test_split_dataset():
    train_dataset, test_dataset, val_dataset = split_dataset(Path(str(Path.cwd())+"/data/raw/raw-img"), split_ratios=(0.8, 0.1, 0.1))
